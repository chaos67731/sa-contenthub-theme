...
class Single_Post_Template {
    ...
    function get_post_templates() {
        ...
        foreach ( (array) $templates as $file => $full_path ) {
            if ( ! preg_match( '|Post Theme:(.*)$|mi', file_get_contents( $full_path ), $header ) )
                continue;
    ...
    function add_metabox() {
        ...
        if ( $this->get_post_templates() )
            add_meta_box( 'pt_post_templates', 'Post Theme', array( $this, 'metabox' ), 'post', 'side', 'high' );
    ...
    function metabox( $post ) {
        ...
        <label class="hidden" for="post_template">Post Template</label><br />
